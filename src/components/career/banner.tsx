...
const Banner: React.FC = () => {
  return (
    <div
      className="bg-no-repeat bg-top bg-cover bg-blend-overlay py-12 md:py-20 min-h-[30vh] md:min-h-[40vh] flex items-center"
      style={{ backgroundImage: `url("/images/career/banner.webp")` }}
    >
      <div className="container max-w-7xl mx-auto px-4 md:px-8">
        <div className="gap-10 md:gap-16 items-center">
          ...
          >
            ...
            >
              Discover a more sustainable future
            </h1>
